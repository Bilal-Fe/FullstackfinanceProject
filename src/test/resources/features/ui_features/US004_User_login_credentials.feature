...
<<<<<<< HEAD:src/test/resources/features/US004_User_login_credentials.feature
  @smoke
=======
  @SmokeTest
>>>>>>> main:src/test/resources/features/ui_features/US004_User_login_credentials.feature
  @admin_login_test
