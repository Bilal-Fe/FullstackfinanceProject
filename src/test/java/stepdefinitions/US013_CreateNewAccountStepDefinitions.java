...
public class US013_CreateNewAccountStepDefinitions {
    ...
    public void user_register_as_an_employee() {
        ...
        manageAccountPage.userName.sendKeys(ConfigReader.getProperty("employee_user_name"));
        manageAccountPage.password.sendKeys(ConfigReader.getProperty("employee_password"));
    ...
    public void userClicksMyOperations() {
        manageAccountPage.myOperations.click();
    }

    @And("user clicks Manage Account")
    public void uerClicksManageAccount() {
        manageAccountPage.manageAccounts.click();
    }
    ...
    public void user_should_be_able_to_see_create_or_edit_a_account_page() {
        Assert.assertEquals(manageAccountPage.myOperations.getText(), "My Operations");
    }
    ...
    public void user_should_be_able_to_verify_new_account() {
