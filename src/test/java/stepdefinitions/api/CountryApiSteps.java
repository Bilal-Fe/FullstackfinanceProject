...
//        List<CountryApi> actualCountry = Arrays.asList(countries);
//        expectedCountry.add("Rwanda");
//        expectedCountry.add("Jordan");
//        Assert.assertTrue(actualCountry.containsAll(expectedCountry));
    }
